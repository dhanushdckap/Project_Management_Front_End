...
<div class="p-4 sm:ml-64">
   ...
   <div>
    <div style="margin-left:47rem;">
        <button type="button" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900"><a href="/project_1.deleted.php">Undeleted Task(1)</a></button>
    ...
    <div>
        <a href="/view_projects.php" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style="width:15rem;height:6rem;">
            <h6 class="mb-2 text-1xl font-bold tracking-tight text-gray-900 dark:text-white">Sample Task-1</h6>
        </a>
    </div>
